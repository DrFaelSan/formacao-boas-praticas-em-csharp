...
public class ImportClientesTest
{
    ...
    public async Task QuandoClienteEstiverNoArquivoDeveSerImportado()
    {
        ...
        Mock<ILeitorDeArquivos<Cliente>> leitorDeArquivo = LeitorDeArquivosMockBuilder.GetMock(listaDeClientes);

        Mock<IApiService<Cliente>> mockService = ApiServiceMockBuilder.GetMock<Cliente>();
        ...
        SuccessWithClientes sucesso = (SuccessWithClientes)resultado.Successes[0];
